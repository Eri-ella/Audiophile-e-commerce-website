...
@vite(['public/js/admin.js'])
    <div class='flex flex-col min-h-screen max-w-50 bg-(--black_color) text-(--white_color) text-sm gap-3 p-5 relative'>
        ...
        <div class='flex flex-col gap-2'>
            ...
            <p class='onglet flex items-center gap-2 p-2 rounded-lg cursor-pointer'><iconify-icon icon="vaadin:lines-list" class='text-[10px]'></iconify-icon>Catégorie</p>
